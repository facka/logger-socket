...
(function init() {
    ...
    var me = document.querySelector('script[id="logger"]');
    var src = me.getAttribute('src');
    var loggerServerURL;
    try {
      loggerServerURL = src.split(':')[1].split('//')[1];
    }
    catch (e) {
      throw 'Please provide server URL for logger: ' + src;
    }

    var socket = io('http://'+loggerServerURL+':3003', {forceNew: true});
